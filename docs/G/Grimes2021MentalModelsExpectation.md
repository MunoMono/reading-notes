---
title: "Mental Models and Expectation Violations in Conversational {{AI}"
...
**Literature clusters:** 10 Conversational AI and completion norms  
...
## Claim 1
- **Claim (plain):**
- **Evidence (quote/paraphrase + page):** ``[@Grimes2021MentalModelsExpectation, p. X]``
