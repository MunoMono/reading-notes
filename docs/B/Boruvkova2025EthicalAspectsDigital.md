...
url: "https://dipp.math.bas.bg/dipp/article/view/dipp.2025.15.20"
...
**Literature clusters:** 01 Synthetic heritage and cultural memory; 05 Archival partiality, silence and absence; 11 Uncertainty and provenance display in interfaces; 12 Digitisation, reconstruction and archival completion  
...
- **Authenticity:** not simply visual plausibility, but a relationship between surviving evidence, historical context, documented intervention and interpretative integrity.
- **Layered authenticity:** recognition that a heritage object can embody multiple historical states and interventions that should remain identifiable rather than being collapsed into a single idealised representation. `[@Boruvkova2025EthicalAspectsDigital, p. 224]`
- **Scoped missingness:** my archival extension of this principle: the system identifies where the available evidence ceases to support reconstruction or inference and retains that limit as part of the historical representation.

# My response (no antithesis; state positives)

- **What I take from this (1–3 bullets):**
  - The distinction between surviving material and interpretative reconstruction gives me a clear heritage precedent for separating archival evidence from AI-mediated inference.
  - Her recommendation to mark inferred content visibly supports the Turin emphasis on provenance as an interface property rather than merely backend metadata.
  - *Layered authenticity* offers a productive conceptual bridge to testimonial plurality: historical integrity may depend on preserving several temporal or interpretative states rather than selecting one synthetic account.

- **What I reframe / adjust (1–2 bullets, stated positively):**
  - I translate material reconstruction into archival inference: the missing hand of a statue may be reconstructed through comparative evidence, whereas a missing institutional relation or undocumented historical judgement may need to remain unresolved.
  - I treat incompletion as potentially evidential. In the DDR archive, a gap can disclose the limits of survival, description, testimony or institutional memory and therefore has analytical value of its own.

- **What question it raises next (1–2 bullets):**
  - What would the textual equivalent of colour-coded reconstructed geometry look like in an archival research interface?
  - Can the interface represent documentary trace, retrospective testimony, computational inference and unresolved absence as distinct evidential layers without overloading the researcher?

# Integration hooks (make it actionable)

- **Where I will cite it (exact paragraph/job):** In the Turin synthetic-heritage discussion when distinguishing computational inference from digital reconstruction, and again in the scoped-missingness section to justify keeping inferred completion distinct from surviving evidence.
- **Where I will name the title in running text (first-use rule):** “Borůvková's *Ethical Aspects of Digital Reconstruction of the Historical Cultural Heritage* extends established heritage principles of authenticity and documentation into the problem of digitally inferred completion.”
- **Link to my practice evidence (one concrete cross-reference):** Turin source-integration and scoped-missingness interface: retrieved source → provenance-bearing citation → AI-mediated interpretation → explicit statement where the corpus cannot establish the requested relationship.
- **Workstreams →** scoped missingness; synthetic heritage; provenance; testimonial plurality; interface uncertainty
- **Deliverables →** Turin discussion; thesis S3 critical-method section; provenance and evidential-state interface specification
- **Stakeholders →** archival researchers; cultural-heritage practitioners; historians; interface designers
...
- **Key pages to reuse:** pp. 217–219, 222–224
- **First full note (write it out here):** Barbora Borůvková, “Ethical Aspects of Digital Reconstruction of the Historical Cultural Heritage,” *Digital Presentation and Preservation of Cultural and Scientific Heritage* 15 (2025): 217–226, https://doi.org/10.55630/dipp.2025.15.20.
- **Short note form:** Borůvková, “Ethical Aspects of Digital Reconstruction,” [page].
- **One quote worth lifting (≤2 lines):** “not as an unquestionable historical fact” (p. 219).
- **One paraphrase worth keeping:** Digital reconstruction should preserve a visible distinction between surviving historical data and interpretative or algorithmically inferred additions, while documenting the evidential basis and limits of intervention. (pp. 219, 223)

# Related works (only if it directly connects)

- The London Charter (2009) — establishes documentation, intellectual transparency and sustainability principles for computer-based cultural-heritage visualisation.
- The Seville Charter (2011) — extends these principles into virtual archaeology and explicitly treats reconstruction as interpretation grounded in available evidence.
- Rouhani (2023), *Ethically Digital: Contested Cultural Heritage in Digital Context* — provides the more explicitly critical heritage framing that Borůvková draws upon when discussing contested representation and digital intervention.
- Arzomand, Kalganova and Rustell (2026), *HARF* — operationalises related principles through evidence-constrained generative reconstruction, paradata and explicit treatment of uncertain features.
- Nieto McAvoy and Kidd (2024), *Synthetic Heritage* — broadens the problem from reconstruction to algorithmically generated cultural memory and the authenticity of synthetic historical representations.

# Follow-ups (next actions, not vibes)

- **What I will read next:** Rouhani (2023) because Borůvková relies on it for the explicitly epistemological and contested-heritage dimension, and it may offer a stronger theoretical bridge from reconstructed objects to contested archival histories.
- **What I will test or write next:** Define evidential layers for the DDR interface analogous to Borůvková's proposed distinction between original and reconstructed material: archival trace; retrospective testimony; computationally inferred relation; conflicting evidence; and scoped missingness.