...
- **Practice cross-check:** This aligns directly with your project’s interest in departmental process, institutional conflict, overlooked actors, and the relation between documents and the design-research activities that generated them. TODO (needs exact DDR process/record cross-link).
...
- **Practice cross-check:** This strongly supports your S3.2 emphasis on provenance, retrieval, and interpretability, especially where computational enrichment could otherwise flatten the archive into generic searchable data. TODO (needs methods/provenance cross-link).
...
- **Practice cross-check:** This aligns with your S3 strand, León on multiliteracy, Boyd Davis/Vane/Kräutli on interrogability, and oral-history work that may help define user-relevant contextual pathways into the DDR archive. TODO (needs interface/prototype cross-link).
...
- **Link to my practice evidence (one concrete cross-reference):** Use alongside your DDR repository map, provenance notes, actor/project relation work, and any prototype that lets users traverse from contextual questions to record clusters. TODO (needs exact cross-reference).
