...
- **Omission and bias / naming and classification / certainty and precision:** the paper’s three main problem families, each operating at source, digitisation, and visualisation levels; I will use this triad as a diagnostic framework for DDR archive interfaces. `[@BoydDavis2021CanBelieveWhat, pp. 524–535]`
- **No neutral visualization:** the paper’s implication that visualisation always embodies intentions, assumptions, and transformations; I will use this to resist presenting visual analytics as passive display. `[@BoydDavis2021CanBelieveWhat, pp. 536–537]`
- **Ethical commitment to eliciting scepticism:** the principle that humanities visualization should help users see reasons for caution, not just consume persuasive outputs; I will use this as a benchmark for design and evaluation in S3. `[@BoydDavis2021CanBelieveWhat, pp. 538]`
...
- **Link to my practice evidence (one concrete cross-reference):** Use alongside Semantic Atlas, Semantic Neighbourhoods, and Comparative Views as visual-method evidence.
